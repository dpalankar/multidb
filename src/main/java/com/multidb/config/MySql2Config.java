...
transactionManagerRef = "productTransactionManager", basePackages = {"com.multidb.mysql2.repo" })
public class MySql2Config {
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.multidb.mysql2.model").persistenceUnit("db2")
				.build();
	}
