...
transactionManagerRef = "customerTransactionManager", basePackages = {"com.multidb.mysql.repo" })
public class MySqlConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.multidb.mysql.model").persistenceUnit("db1")
				.build();
	}
